/*
  # Remove Admin Roles and Update Policies
  
  1. Changes
    - Remove all admin-specific policies
    - Grant management access to all authenticated users
    - Simplify role system to just use authenticated status
